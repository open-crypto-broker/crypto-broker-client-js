...
var CryptoGrpcClientImpl = class {
	...
	Benchmark(request) {
		...
		return this.rpc.request(this.service, "Benchmark", data).then((data) => BenchmarkResponse.decode(new _bufbuild_protobuf_wire.BinaryReader(data)));
	}
	Hash(request) {
		const data = HashRequest.encode(request).finish();
		return this.rpc.request(this.service, "Hash", data).then((data) => HashResponse.decode(new _bufbuild_protobuf_wire.BinaryReader(data)));
	}
	Sign(request) {
		const data = SignRequest.encode(request).finish();
		return this.rpc.request(this.service, "Sign", data).then((data) => SignResponse.decode(new _bufbuild_protobuf_wire.BinaryReader(data)));
	}
	FakeEndpoint(request) {
		const data = FakeEndpointRequest.encode(request).finish();
		return this.rpc.request(this.service, "FakeEndpoint", data).then((data) => FakeEndpointResponse.decode(new _bufbuild_protobuf_wire.BinaryReader(data)));
	}
};
...
var HealthClientImpl = class {
	...
	Check(request) {
		...
		return this.rpc.request(this.service, "Check", data).then((data) => HealthCheckResponse.decode(new _bufbuild_protobuf_wire.BinaryReader(data)));
	}
	List(request) {
		const data = HealthListRequest.encode(request).finish();
		return this.rpc.request(this.service, "List", data).then((data) => HealthListResponse.decode(new _bufbuild_protobuf_wire.BinaryReader(data)));
	}
};
...
var CryptoBrokerClient = class {
	...
	constructor(opts = {}) {
		...
		this.conn = new _grpc_grpc_js.Client(this.address, opts.credentials || _grpc_grpc_js.credentials.createInsecure(), client_options);
...
const credentials = _grpc_grpc_js.credentials;
//#endregion
