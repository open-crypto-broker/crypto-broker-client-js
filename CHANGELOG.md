...
- Updated packages, override tslib (#88)
...
- Circuit breaker (#73)
- Add license check (#69)
- Add dependabot config (#63)
- Added git hash to version (#64)
- Version number (#62)

### 🐛 Bug Fixes

- Adjust permissions for npm version bump (#74)

### 🚜 Refactor

- Conf and protobuf (#72)
- Adjust workflow files (#66)
